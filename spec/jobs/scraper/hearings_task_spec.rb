describe Scraper::HearingsTask do
  ...
  describe "#scrape_paged_committee_hearings" do
    ...
    context "normally" do
      ...
      it "aggregates results from all pages" do
        ...
        expect(result).to eq([:committee_hearing, :committee_hearing, :committee_hearing])
      end
    end
    ...
    context "when it has no paging link" do
      ...
      it "does not page" do
        ...
        expect(result).to eq([:committee_hearing, :committee_hearing])
      end
    end
  ...
  describe "#build_committee_hearing_attrs" do
    ...
    let(:committee_id) { "#{Faker::Number.number(5)}" }
  ...
  describe "#build_hearing_attrs" do
    let(:cols) { 4.times.map { double("column") }}
