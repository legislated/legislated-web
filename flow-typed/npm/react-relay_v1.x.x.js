...
declare module "react-relay" {
  ...
  declare export type RelayProps = {
    relay: RelayProp
  };
  ...
  declare export type RelayPaginationProps = {
  ...
  declare export type RelayRefetchProps = {
  ...
  declare export function createFragmentContainer<
    TProps,
    TSource: React$ComponentType<RelayProps & $Supertype<TProps>>,
    TResult: React$ComponentType<TProps>
  >(
    Component: TSource,
  ...
  declare export function createRefetchContainer<
    TProps,
    TSource: React$ComponentType<RelayRefetchProps & $Supertype<TProps>>,
    TResult: React$ComponentType<TProps>
  >(
    Component: TSource,
    fragmentSpec: GraphQLTaggedNode | GeneratedNodeMap,
  ...
  declare export function createPaginationContainer<
    TProps,
    TSource: React$ComponentType<RelayPaginationProps & $Supertype<TProps>>,
    TResult: React$ComponentType<TProps>
  >(
    Component: TSource,
    fragmentSpec: GraphQLTaggedNode | GeneratedNodeMap,
