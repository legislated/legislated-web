...
module Scraper
  class Task
    ...
    # hearings
    def add_hearings_to_chambers(chambers)
      chambers.each do |chamber|
        chamber.hearings = all_hearings_from_chamber_page(chamber)
      end
    end

    def all_hearings_from_chamber_page(chamber)
    ...
    def hearings_from_chamber_page(chamber, url, page_number = 0)
      puts "\n- visit chamber"
    ...
    def create_hearing(row, hearings_map)
      ...
      # TODO: convert to boolean, all values seen so far are '0'
    ...
    def create_committee(committee_hearing_data)
    ...
    # bills
    def bills_from_hearing_page(hearing, url)
